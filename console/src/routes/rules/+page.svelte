<script lang="ts">
    ...
    let availableChannels: NotificationChannelWithId[] = $state([]);
...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">
            Configure notification rules for device events
        </p>
    </div>
            ...
            <div class="rule-header">
                <div style="flex: 1;">
                    <div class="rule-title">
                        <span>{rule.name}</span>
                        <span
                            class="badge badge-{rule.enabled
                                ? 'success'
                                : 'secondary'}"
                        >
                    ...
                    <div class="rule-meta">
                        ...
                        {#if rule.notification_channels.length > 0}
                            <div class="rule-meta-item">
                                ...
                                <span
                                    >{rule.notification_channels.length} configured</span
                                >
                            </div>
                        {/if}
                    </div>
    ...
    <form onsubmit={handleSubmit}>
        ...
        <div class="form-group">
            ...
            >
                ...
                <option value="device_status_change"
                    >Device Status Change</option
                >
            </select>
        </div>

        <div class="form-group">
            <label class="form-label" for="mac_filter"
                >MAC Filter (optional)</label
            >
            <input
                type="text"
                id="mac_filter"
        ...
        <div class="form-group">
            ...
            {:else}
                <p class="form-helper">
                    Enter channel names as configured in Settings → Notification
                    Channels
                </p>
            {/if}
        </div>
